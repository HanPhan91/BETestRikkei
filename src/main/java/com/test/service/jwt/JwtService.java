package com.test.service.jwt;

import com.test.model.UserPrinciple;
...
public class JwtService {
    private static final String SECRET_KEY = "BEJuniorJavaTestRikkeiSoftwareCompanyPhanGiaHan1991gmaildotcom";
